# camera_picamera2.py — Picamera2/libcamera backend (Raspberry Pi Camera Module 3)
# Implements the camera backend interface selected by camera.py when
# CameraBackend == "picamera2" (the default). See camera.py for the dispatcher
# and camera_arducam_usb3.py for the alternate USB3 monochrome backend.
...
# =============================================================================
DEFAULTS = {
    "CameraBackend": "picamera2",   # ADDED 081226 — "picamera2" or "arducam_usb3"; see camera.py
